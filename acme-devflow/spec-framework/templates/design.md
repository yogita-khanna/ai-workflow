...
*INSTRUCTION TO ARCHITECT: This document dictates exact implementation bounds. Any deviation during the implementation phase requires a formal delta-spec. NO ORMS ALLOWED. Use raw pg queries.*
...
## 1. Traceability Map
*Map Spec Acceptance Criteria to Technical Components:*
