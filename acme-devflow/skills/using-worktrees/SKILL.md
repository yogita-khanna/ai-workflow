---
trigger: "Setup and teardown Git worktrees for isolated development in our pnpm monorepo."
---
...
3. **Install Dependencies**: Run `pnpm install` in the new worktree to link the monorepo packages.
...
- **Running npm instead of pnpm**: This is a strict `pnpm workspace` setup. Using npm or yarn will break lockfiles and phantom dependencies.
- **Port Collisions**: Starting `pnpm turbo run dev` in two worktrees will crash due to Next.js trying to bind port 3000 in both.
