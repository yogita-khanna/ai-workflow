...
_INSTRUCTION TO DEVELOPER: This checklist enforces a Directed Acyclic Graph (DAG) for implementation. You MUST complete Phase 1 before Phase 2. For every code task, you MUST write the test (RED) before the implementation (GREEN)._
